...
void Game::init(void *name) {
    ...
    _enemy_1 = new EnemyShip(10, 10, 0.5, true);
    _enemy_2 = new EnemyShip(705, 10, 0.1, false);
    _enemy_3 = new EnemyShip(10, 685, 0.1, true);
    _enemy_4 = new EnemyShip(705, 685, 0.1, false);
